...
class PollsControllerTest < ActionController::TestCase
  ...
  test "should create poll" do
    assert_difference('Poll.count') do
      post :create, poll: { date: @poll.date, poller: @poll.poller, population: @poll.population, source: @poll.source }
    end
  ...
  test "should update poll" do
    patch :update, id: @poll, poll: { date: @poll.date, poller: @poll.poller, population: @poll.population, source: @poll.source }
    assert_redirected_to poll_path(assigns(:poll))
  end
